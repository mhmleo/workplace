...
scm_significance_tbl |>
  ...
  # --- Title & Subtitle ---
  tab_header(
    title    = md("**SCM Inference: MSPE Ratios & Permutation Test**"),
    subtitle = md("Pre/Post-NAFTA ratio ranked across donor pool")
  ) |>
  
  # --- Source note ---
  tab_source_note(
    source_note = md("*Note:* Fisher's exact p-value = rank / total units | MSPE = Mean Squared Prediction Error")
  ) |>
