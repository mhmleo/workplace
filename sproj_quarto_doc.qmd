...
calculate_rca_generalized <- function(country_sector_df,
  ...
  #first, I aggregate by year and product, with variables period, and cmdCode
...
We need the dataframes above in order to complete the rest of the RCA Analysis. They are imperative in order so that the RCA variable can be calculated at a snaoshto in time, and
